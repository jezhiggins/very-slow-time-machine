...
From that you can create a DIP, a Display Information Package. The DIP might be the same as the AIP, but probably isn't. You might present the document in a different format - a PDF say, or some of the document might be
